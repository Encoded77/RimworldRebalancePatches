...
namespace RebalancePatches.Tests
{
    ...
    public static class HalffootTests
    {
        ...
        {
            if (!Check.Ready("genetics.dedup", Ids.AlphaGenes, Ids.BigSmallCore, Ids.CherryPicker, Ids.Halffoot))
                return;
        ...
        {
            if (!Check.Ready("genetics.dedup", Ids.AlphaGenes, Ids.CherryPicker, Ids.Halffoot))
                return;
